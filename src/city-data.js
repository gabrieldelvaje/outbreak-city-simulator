...
export const riverY = x => 345 + 66 * Math.sin(x / 185) + 0.11 * x;

// The bridges are the only road connections allowed across the river.
...
// District labels are placed away from the river, road junctions and public facilities.
export const districts = [
  ...
  {id:'colinas-do-sul',name:'Colinas do Sul',x:1360,y:865,side:'sul',type:'Residencial · lazer'}
];

// Parks occupy actual urban blocks, not ellipses drawn behind streets.
export const parks = [
  {x:100,y:185},{x:700,y:185},{x:1500,y:185},
  {x:100,y:635},{x:700,y:725},{x:1500,y:815}
];

// Every public place sits at the center of a reserved block (grid centers x=100+100n, y=95+90n).
// This shared position is used by the visual parcel, clickable hub and future simulation graph.
export const places = [
